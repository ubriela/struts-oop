...
public class DownloadCorrectedAction extends DownloadAction {
    ...
    protected StreamInfo getStreamInfo(ActionMapping mapping, 
        ...
        StoreBean storedFile= StudentService.getCorrectedPath(Integer.parseInt(request.getParameter("exerciseId")));
