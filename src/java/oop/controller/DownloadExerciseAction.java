...
public class DownloadExerciseAction extends DownloadAction {
    ...
    protected StreamInfo getStreamInfo(ActionMapping mapping, 
        ...
        StoreBean storedFile= StudentService.getExercisePath(Integer.parseInt(request.getParameter("exerciseId")));
