...
public class SendExerciseFCKAction extends Action {
    ...
    ExerciseForm exerciseForm= (ExerciseForm) form;
    StudentExerciseBean exerciseBean= new StudentExerciseBean();
    exerciseBean.setName(exerciseForm.getName());
    exerciseBean.setSubjectId(exerciseForm.getSubjectId());
    exerciseBean.setDeadline(exerciseForm.getDeadline());
    exerciseBean.setDescription(exerciseForm.getDescription());
    exerciseBean.setPercent(exerciseForm.getPercent());
    ...
    LecturerService.sendExerice(userbean.getUserId(),exerciseBean,fullName,pureName);
    // Forward to the appropriate View
    
    ArrayList exercises = null;
        
    exercises= TeacherService.getExercises(exerciseForm.getSubjectId());
