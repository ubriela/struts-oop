...
<html>
  ...
  <body>
      ...
      <html:form  action="/SendCorrected" method="post" enctype="multipart/form-data" acceptCharset="UTF-8" >
      <table width="500" border="0">
        ...
        <tr>
          <td>Bài chữa: <html:file property="theFile" /> </td>
        </tr>
         <tr>
          <td>
            <html:submit>Gửi bài chữa</html:submit>
          </td>
        </tr>
      </table>
    </html:form> 
